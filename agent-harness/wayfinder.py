...
8. Return ONLY one JSON object conforming to agent-harness/schemas/wayfinder-result.schema.json.
"""
...
Use decision=null. Return ONLY agent-harness/schemas/wayfinder-result.schema.json.
"""
...
Return ONLY agent-harness/schemas/wayfinder-handoff.schema.json.
"""
...
AC-* and VC-* and one final integration task depending on evaluator. Return ONLY agent-harness/schemas/wayfinder-tasks-result.schema.json.
"""
