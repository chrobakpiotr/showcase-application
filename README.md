...
<!-- showcase-readme-refresh -->

[![CI](https://github.com/chrobakpiotr/showcase-application/actions/workflows/ci.yml/badge.svg)](https://github.com/chrobakpiotr/showcase-application/actions/workflows/ci.yml)
[![CodeQL](https://github.com/chrobakpiotr/showcase-application/actions/workflows/codeql.yml/badge.svg)](https://github.com/chrobakpiotr/showcase-application/actions/workflows/codeql.yml)
[![OpenSSF Scorecard](https://api.scorecard.dev/projects/github.com/chrobakpiotr/showcase-application/badge)](https://scorecard.dev/viewer/?uri=github.com/chrobakpiotr/showcase-application)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE)

A production-shaped e-commerce playground built to demonstrate modern **Java 25 / Spring Boot / Angular** engineering:
hexagonal architecture, transactional messaging, concurrency control, OAuth2, observability, cloud/infra tooling,
AI-assisted workflows and an end-to-end operator UI in one repository.

This README covers setup, architecture, engineering tooling and operations.
For business capabilities, read the [domain guide](docs/domain-guide.md); for a walkthrough, use the
[demo guide](docs/demo-guide.md). Optional AI scenarios live in the [AI guide](docs/ai-guide.md).

## Quick start

**Prerequisites:** JDK 25+ and Docker Desktop / Docker Engine with Compose.
...
Then open **`http://localhost:9080/home`** and sign in with `order-admin` / `password` for full demo access.
The application API is under `/home/api/**`, Swagger UI is at `/home/swagger-ui/index.html`, actuator runs on port
`9081`, and Grafana is available at `http://localhost:3000`.

For a faster tour, follow the [demo guide](docs/demo-guide.md). For IDE/local-profile workflows, optional integrations
and teardown commands, continue with [Starting the application](#starting-the-application).

## Documentation map

- [Domain and business capabilities](docs/domain-guide.md) - bounded contexts, business rules and operator workflows.
- [Demo guide](docs/demo-guide.md) - seeded data and repeatable manual scenarios.
- [AI guide](docs/ai-guide.md) - optional AI integrations, setup and scenarios.
...
[AI-assisted order-remarks triage](docs/ai-guide.md#ai-assisted-order-remarks-triage-ollama),
[AI customer-support assistant](docs/ai-guide.md#ai-customer-support-assistant-rag--tool-calling-ollama),
[AI ops-analytics assistant](docs/ai-guide.md#ai-ops-analytics-assistant-tool-calling-ollama),
[AI personalized product recommendations](docs/ai-guide.md#ai-personalized-product-recommendations-ollama),
[AI ops digest](docs/ai-guide.md#ai-ops-digest-scheduled-ollama),
[AI language detection for order confirmations](docs/ai-guide.md#ai-language-detection-for-order-confirmations-ollama) and
[AI-assisted duplicate-order detection](docs/ai-guide.md#ai-assisted-duplicate-order-detection-ollama)
guides and sections linked above.
...
- `OrderPlacementSagaOrchestrator` then drives each pending outbox row through the saga:
  1. **`ensurePaymentCaptured` (mock gateway)** - the saga's first pivot step (see
     [Payment](docs/domain-guide.md#payment)): captures the order's payment before fulfillment is ever notified. A decline is
  ...
  3. Send confirmation e-mail, export to S3, publish the SQS audit event, publish the Kafka analytics event,
     ...
     [AI-assisted order-remarks triage](docs/ai-guide.md#ai-assisted-order-remarks-triage-ollama)) - unchanged best-effort
