...
The repository is intentionally broad, but the entry path is simple: start the local stack, sign in with a demo user,
and exercise real business flows against deterministic demo catalog/stock data.
...
[docs/demo-guide.md](docs/demo-guide.md) for the complete SKU/stock table, reset instructions and suggested flows.
