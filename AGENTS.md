...
- `tooling/` - deploy/runtime/config contracts (AsyncAPI, Docker, Kubernetes/Helm, Terraform, etc.).
...
- `tasks.json` - dependency DAG; machine-readable by `tooling/agent-harness/harness.py`; risk-driven builders declare test mode/seam.
