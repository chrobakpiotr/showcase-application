# APP-ORCH-001 - thin controllers and application workflows

## Intent

Move cross-bounded-context order placement, return moderation and shipment orchestration out of MVC controllers.
