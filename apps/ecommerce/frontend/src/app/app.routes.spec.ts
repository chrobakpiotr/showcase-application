...
describe('app routes', () => {
  ...
  it('defines guarded order route', async () => {
    ...
    expect(orderRoute?.canActivate?.length).toBe(2);
  ...
  it('defines guarded orders route', async () => {
    ...
    expect(ordersRoute?.canActivate?.length).toBe(2);
  ...
  it('defines guarded analytics route', async () => {
    ...
    expect(analyticsRoute?.canActivate?.length).toBe(2);
  ...
  it('defines guarded catalog route', async () => {
    ...
    expect(catalogRoute?.canActivate?.length).toBe(2);
  ...
  it('defines guarded cart route', async () => {
    ...
    expect(cartRoute?.canActivate?.length).toBe(2);
  ...
  it('defines guarded wishlist route', async () => {
    ...
    expect(wishlistRoute?.canActivate?.length).toBe(2);
  ...
  it('defines guarded recommendations route', async () => {
    ...
    expect(recommendationsRoute?.canActivate?.length).toBe(2);
  ...
  it('defines guarded inventory route', async () => {
    ...
    expect(inventoryRoute?.canActivate?.length).toBe(2);
  ...
  it('defines guarded reviews route', async () => {
    ...
    expect(reviewsRoute?.canActivate?.length).toBe(2);
  ...
  it('defines guarded returns route', async () => {
    ...
    expect(returnsRoute?.canActivate?.length).toBe(2);
  ...
  it('defines guarded notifications route', async () => {
    ...
    expect(notificationsRoute?.canActivate?.length).toBe(2);
  ...
  it('defines guarded coupons route', async () => {
    ...
    expect(couponsRoute?.canActivate?.length).toBe(2);
    const component = await couponsRoute?.loadComponent?.();
    expect(component).toBeDefined();
  });

  it('defines authenticated forbidden route', async () => {
    const forbiddenRoute = routes.find((route) => route.path === 'forbidden');
    expect(forbiddenRoute?.canActivate?.length).toBe(1);
    const component = await forbiddenRoute?.loadComponent?.();
    expect(component).toBeDefined();
  });
