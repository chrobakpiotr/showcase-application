...
public class ReturnService implements ReturnWorkflow {
    ...
    private final ReturnApprovalRefundPreparationTransaction approvalPreparationTransaction;
    ...
    public ReturnRequest approveReturn(final String returnNumber) {
        final ReturnRequest approved = approvalPreparationTransaction.approveAndPrepare(returnNumber);
        if (approved == null) {
