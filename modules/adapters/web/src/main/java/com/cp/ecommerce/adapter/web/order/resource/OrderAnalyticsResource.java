...
public record OrderAnalyticsResource(@Schema(example = "a343b57f-f1b0-46c4-846c-f8ee538f30f0-3") String orderNumber,
        @Schema(example = "3") Long customerId, @Schema(example = "2024-03-15T10:30:00.000Z") Instant orderPlacedDate,
        @Schema(example = "2024-03-15T10:30:02.500Z") Instant consumedDate) {
